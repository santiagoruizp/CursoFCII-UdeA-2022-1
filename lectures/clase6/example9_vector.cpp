...
int main(){
  ...
  /*
  // Cambie el tamaño del vector
  cout << "\nCurrent integers3 size is: " << enteros3.size() << endl;
  enteros3.push_back(1000); // add 1000 to the end of the vector
  cout << "New integers3 size is: " << enteros3.size() << endl;
