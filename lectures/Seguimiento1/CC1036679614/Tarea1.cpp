...
int main()
{
  ...
  cout << "1. Area rectangular (chip)"<< endl;
  ...
  if (var=="1"){
    ...
    cin >> ancho;
    cout << "La tasa de calor transferido al chip: "<< (T_s-T_a)*largo*ancho*AIRCONV << " watts";
  }
  if (var=="2"){
    float semi_mayor{0};
    float semi_menor{0};
  ...
  if (var=="4"){
    ...
    cout << "Ingrese el area en metros: " << endl;
    cin >> Area;
    cout << "La tasa de calor transferido es al chip: "<< Area*AIRCONV*(T_s-T_a) << " watts";
  }
  return 0;
